...
public class FloodProNSGAIIRunner extends AbstractAlgorithmRunner {
    public static void main(String[] args) throws JMetalException, FileNotFoundException {
        ...
        String problemName = "floodProNew";
        double[] levelStartSX = {145.0};
        problem = new FloodProProblem(122,1,levelStartSX);
...
//        tableHeadDimension.add(" ");
        ...
        boolean flag = ExcelUtil.exportExcel(population, "非劣前沿结果", tableHead, tableHeadDimension,basePath+ problemName +"NSGAII.xls");
        if(flag) {
