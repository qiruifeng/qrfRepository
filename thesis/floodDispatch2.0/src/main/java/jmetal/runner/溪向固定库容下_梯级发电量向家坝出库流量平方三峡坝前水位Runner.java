...
import jmetal.problem.溪向固定库容下_梯级发电量向家坝出库流量平方三峡坝前水位;
...
public class 溪向固定库容下_梯级发电量向家坝出库流量平方三峡坝前水位Runner extends AbstractAlgorithmRunner {
    public static void main(String[] args) {
        ...
        String problemName = "溪向固定库容下_梯级发电量向家坝出库流量平方三峡坝前水位Runner";
        double[] levelStart = {560.0, 370.0, 145.0};//三个库的起调水位
        double reserveStorage = 30.0;
        int sheetIndex = 4;
        int[] T = {89, 102};

        problem = new 溪向固定库容下_梯级发电量向家坝出库流量平方三峡坝前水位(T, 3, levelStart, reserveStorage, sheetIndex);
        ...
        algorithm = new NSGAII45<DoubleSolution>(problem, 50000, 200, crossover, mutation,
