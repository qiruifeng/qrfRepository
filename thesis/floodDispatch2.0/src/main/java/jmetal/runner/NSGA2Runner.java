...
public class NSGA2Runner extends AbstractAlgorithmRunner {
    public static void main(String[] args) throws JMetalException, FileNotFoundException {
        ...
        algorithm = new NSGAII45<DoubleSolution>(problem, 5000, 100, crossover, mutation,
...
//        tableHeadDimension.add(" ");
        ...
        boolean flag = ExcelUtil.exportExcel(population, "非劣前沿结果", tableHead, tableHeadDimension,basePath+ problemName +"NSGA2.xls");
        if(flag) {
