...
import jmetal.problem.溪向库容和溪向发电量和三峡最高水位最低_三峡优化;
...
public class 溪向库容和溪向发电量和三峡最高水位最低_三峡优化Runner {
    public static void main(String[] args) {
        ...
        String problemName = "溪向库容和溪向发电量和三峡最高水位最低_三峡优化Runner";
        ...
        problem = new 溪向库容和溪向发电量和三峡最高水位最低_三峡优化(T, 3, levelStart,sheetIndex);
