...
import jmetal.problem.FloodProMaxProblem;
...
public class FloodProMaxProblemRunner {
    public static void main(String[] args) {
        ...
        String problemName = "floodProThreeMaxStation";
        double[] levelStart = {570.0, 370.0, 145.0};//三个库的起调水位
        double reserveStorage = 20.0;//亿m³
        int[] T = {85, 96};
        int[] period = {92, 94};//

        problem = new FloodProMaxProblem(T[1] - T[0], 3, levelStart, T, reserveStorage, period);
